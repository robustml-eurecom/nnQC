...
from nnqc.utils import KL_loss, define_instance, prepare_msd_dataloader, setup_ddp, compute_spacing
...
def main():
    ...
    if args.is_msd:
        ...
        # prepare_general_dataloader returns (train, val) or (train, val, test) depending
        # on whether the split leaves any test items - absorb the optional 3rd value.
